    ...
    auto thresholdAssertMatcherCallback = [conn](sdbusplus::message_t& msg) {
        ...
        else if (event == "PerformanceLossHigh")
        {
            ...
            if (assert)
            {
                ...
                direction = "high";
                redfishMessageID +=
                    ".SensorThresholdPerformanceLossHighGoingHigh";
            }
            else
            {
                eventType = eventInfo;
                direction = "low";
                redfishMessageID +=
                    ".SensorThresholdPerformanceLossHighGoingLow";
            }
        }
        else if (event == "PerformanceLossLow")
        {
            ...
            if (assert)
            {
                ...
                direction = "low";
                redfishMessageID +=
                    ".SensorThresholdPerformanceLossLowGoingLow";
            }
            else
            {
                eventType = eventInfo;
                direction = "high";
                redfishMessageID +=
                    ".SensorThresholdPerformanceLossLowGoingHigh";
            }
        }
