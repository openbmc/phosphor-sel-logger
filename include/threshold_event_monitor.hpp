    ...
    std::shared_ptr<sdbusplus::asio::connection> conn)
{
    auto thresholdEventMatcherCallback = [conn](
        ...
        double max = mapbox::util::apply_visitor(ipmi::VariantToDoubleVisitor(),
                                                 sensorValue["MaxValue"]);
        double min = mapbox::util::apply_visitor(ipmi::VariantToDoubleVisitor(),
                                                 sensorValue["MinValue"]);
        double sensorVal = mapbox::util::apply_visitor(
