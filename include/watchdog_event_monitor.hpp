    ...
    std::shared_ptr<sdbusplus::asio::connection> conn)
{
    auto watchdogEventMatcherCallback = [conn](sdbusplus::message::message& msg) {
        ...
        boost::container::flat_map<std::string, std::variant<std::string , uint64_t, bool>>::iterator
        getWatchdogEnabled, getExpireAction, getPreTimeoutInterrupt, getCurrentTimerUse ,getWatchdogInterval;
